этот проект - попытка реализации консольной РПГ-шки с основными механиками: Перемещение, Боя, Визуального отображения противников, экиперованных предметов и тд.
